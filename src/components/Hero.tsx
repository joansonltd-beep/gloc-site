...
export default function Hero({ settings }: { settings: SiteSettings }) {
  return (
    <section className="relative grid items-center gap-8 sm:gap-10 md:grid-cols-2">
      {/* Warm decorative glow behind the hero. */}
      <div
        aria-hidden
        className="pointer-events-none absolute -left-24 -top-28 -z-10 h-72 w-72 rounded-full bg-accent/20 blur-3xl"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -right-16 top-10 -z-10 h-72 w-72 rounded-full bg-brand/20 blur-3xl"
      />
